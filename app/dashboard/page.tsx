...
export default function Dashboard() {
  return (
    <div className="min-h-screen bg-slate-700 flex flex-col p-4">
      {/* Header */}
      <header className="text-primary text-xl font-semibold mb-4">SurfSync Dashboard</header>

      {/* Map placeholder */}
      <div className="flex-1 bg-neutral rounded-xl flex items-center justify-center text-secondary text-sm mb-4">
        <span>Map Loading...</span>
      </div>

      {/* Session status and button */}
      <div className="mb-4">
        <div className="flex items-center justify-between mb-2">
          <span className="text-white text-sm">
            Session: <span className="text-error">inactive</span>
          </span>
